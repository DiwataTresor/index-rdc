...
const page=()=>{
  ...
  return (
    <>
    {contextHolder}
    <MainLayout navigationBar="Gestion des actualités">
        <Layout titre="Publication des actualités de votre organisation">
            <Tabs 
                aria-label="Options" 
                color="primary" 
                variant="underlined"
                    ...
                    <div className="items-center justify-center  rounded-md py-4 px-3">
                        ...
                        <div className="border-0 shadow-sm rounded-md flex px-4 py-7 bg-white">
                            ...
                            <div className="flex flex-col gap-6 flex-1">
                                <Input name="titre" type="text" label="Titre actualité" isRequired />
                                <div className="flex flex-col gap-3">
                                    <Checkbox name="typePublication" defaultSelected={false}>Publier instantanement</Checkbox>
                                    <Input name="datePublication" type="date"  label="Date publication" value={moment().format("YYYY-MM-DD")} />
                                </div>
                                        ...
                                        <div className="flex flex-col gap-3 shadow-md border mb-4 rounded-md px-2 py-2 bg-slate-100">
                                            ...
                                            <div className="flex-1 flex gap-3  mb-2 ">
                                                ...
                                                <div className="flex-1">
                                                        <h1 className="text-center text-xl font-bold">{ac.titre}</h1>
                                                        <Alert message={<div>{ac.description}</div>} />
                                                </div>
                                            </div>
                                            <div className="flex items-end justify-end border-t py-2">
                                                <Button onPress={()=>{
                                                    ModalAnt.confirm({
                                                        title:"Suppression",
                                                        content:"Voulez-vous vraiment supprimer cette actualité ?",
                                                        okText:"Supprimer",
                                                        cancelText:"Annuler",
                                                        onOk:()=>{
                                                            setSpinning(true);
                                                            deleteData(`actualite`,{id:ac.id}).then(r=>{
                                                                openNotification();
                                                                getActus();
                                                            }).catch(err=>{
                                                                openNotificationError();
