...
const Formulaire=()=>{
    ...
    return (
  <>
    <div className="flex flex-row gap-5 px-[80px] mx-auto">
        <div className={fContainer + " flex-1"}>
            <label for='nom' className={fLabel}>Nom *</label>
...
export default function Component() {
  return (
    <div>
      ...
      <div className={myContainer + " py-[40px]"}>
              <div className="flex flex-col gap-8 ">
                <div className="flex-1 px-[100px]">
                    ...
                    <div className="flex flex-row gap-6 mt-8 mx-[90px] bg-white rounded-md py-[40px] px-4">
                        <p className="w-1/3 flex flex-row gap-2 items-center">
                            <svg width="42px" height="42px" stroke-width="1.4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#fb6a09"><path d="M22 5h-6m0 0l3-3m-3 3l3 3M18.118 14.702L14 15.5c-2.782-1.396-4.5-3-5.5-5.5l.77-4.13L7.815 2H4.064c-1.128 0-2.016.932-1.847 2.047.42 2.783 1.66 7.83 5.283 11.453 3.805 3.805 9.286 5.456 12.302 6.113 1.165.253 2.198-.655 2.198-1.848v-3.584l-3.882-1.479z" stroke="#fb6a09" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                            {telephone}
                        </p>
                        <p className="w-1/3 flex flex-row gap-2 items-center">
                            <svg width="42px" height="42px" viewBox="0 0 24 24" stroke-width="1.4" fill="none" xmlns="http://www.w3.org/2000/svg" color="#fb6a09"><path d="M9 9l4.5 3L18 9M3 13.5h2M1 10.5h4" stroke="#fb6a09" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5 7.5V7a2 2 0 012-2h13a2 2 0 012 2v10a2 2 0 01-2 2H7a2 2 0 01-2-2v-.5" stroke="#fb6a09" stroke-width="1.4" stroke-linecap="round"></path></svg>
                            {email}
                        </p>
                        <p className="w-1/3 flex flex-row gap-2 items-center">
                            <svg width="72px" height="72px" stroke-width="1.4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#fb6a09"><path d="M20 10c0 4.418-8 12-8 12s-8-7.582-8-12a8 8 0 1116 0z" stroke="#fb6a09" stroke-width="1.4"></path><path d="M12 11a1 1 0 100-2 1 1 0 000 2z" fill="#fb6a09" stroke="#fb6a09" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                            {adresse}
                        </p>
                    </div>
                </div>
