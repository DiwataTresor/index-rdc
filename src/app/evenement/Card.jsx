                    ...
                    <div className="flex flex-row  justify-between">
                        ...
                        <div>
                            <span className="bg-slate-300 bg-opacity-75 rounded-full px-4 py-2 flex justify-center items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="none" stroke-width="1.4" viewBox="0 0 24 24" color="#0d0c0d"><path stroke="#0d0c0d" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" d="M18 22a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM18 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM6 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"></path><path stroke="#0d0c0d" stroke-width="1.4" d="m15.5 6.5-7 4M8.5 13.5l7 4"></path></svg>                                
                            </span>
                        </div>
                    </div>
                </div>
